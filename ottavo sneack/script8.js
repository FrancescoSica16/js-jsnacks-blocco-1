 ...
 */
  ...
  for (let i = 0; i < 8; i++) {
     ...
     randomName = listaNomi[(Math.floor(Math.random()*listaNomi.length))];
     randomSurname = listaCognomi[(Math.floor(Math.random()*listaNomi.length))];

     nomeIntero = randomName + " " + randomSurname;
     listaInvitati.push(nomeIntero) ;
     document.getElementById("invitati").innerHTML +=  "<li>" + nomeIntero + "</li> ";
  }
